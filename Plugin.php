 ...
 * @author SakuraDon
 * @version 1.0.0
 * @link https://blog.sakuradon.com
 */
class CodeBeautify_Plugin implements Typecho_Plugin_Interface {
     /**
    ...
    public static function header() {
        $style = Helper::options()->plugin('CodeBeautify')->code_style;
        $cssUrl = Helper::options()->pluginUrl . '/CodeBeautify/static/styles/' . $style;
    ...
    public static function footer() {
        $jsUrl = Helper::options()->pluginUrl . '/CodeBeautify/static/prism.js';
        $jsUrl_clipboard = Helper::options()->pluginUrl . '/CodeBeautify/static/clipboard.min.js';
        $showLineNumber = Helper::options()->plugin('CodeBeautify')->showLineNumber;
        if ($showLineNumber) {
            echo <<<HTML
